    ...
    <>
      <div className="flex items-center justify-center">
        ...
        {type === "xl" && (
          ...
          >
            <div
              className={`z-10 bg-photopicker-overlay-background h-60 w-60 absolute left-0 top-0 flex items-center rounded-full justify-center flex-col text-center gap-2 
